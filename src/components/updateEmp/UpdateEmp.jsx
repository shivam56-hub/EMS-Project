...
export default function UpdateEmp() {
  ...
  const handleSubmit = async (e) => {
    ...
    setMessage("");
    console.log("Updating ID:", state.id);
    console.log("Data:", updateEmp);
    {
      try {
        await updateEmployee(state.id, updateEmp);
        setMessage({
          error: false,
          msg: "Employee updated successfully...redirecting to home in 2 sec...",
        });
  ...
  return (
    <div className="addEmp">
      ...
      <div className="form-container container-fluid d-flex justify-content-center align-items-center mt-4">
        <form
          className="bg-white p-5 rounded shadow-lg form-responsive"
          style={{
